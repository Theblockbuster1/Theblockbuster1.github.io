 ...
 */
 ...
 App.draw = function() {
   ...
   for (var i = 0; i < this.particles.length; i++) {
     ...
     if (!window.lineColors) lineColors = {
     ...
     this.ctx.strokeStyle = 'hsla(' + lineColors.h + ', ' + lineColors.s + '%, ' + lineColors.l + '%, ' + lineColors.a + ')';
     this.ctx.fillStyle = 'hsla(' + lineColors.h + ', ' + lineColors.s + '%, ' + lineColors.l + '%, ' + lineColors.a + ')';
